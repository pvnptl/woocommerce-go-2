...
Only tested in API v3, if you are use v1 or v2, please [Report an issue](https://github.com/itbellissimo/woocommerce-go/issues/new).

## Install

```go
go get github.com/itbellissimo/woocommerce-go
```
...
1. [Report an issue](https://github.com/itbellissimo/woocommerce-go/issues/new)
